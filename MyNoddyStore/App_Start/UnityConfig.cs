    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            mock.Setup(m => m.Products).Returns(new List<Product> { //a list automatically implements IEnumerable!.
                ...
                new Product { ProductID = 4, Name = "Corner Flags", Description = "For the field", Category = "Football", Price = 34.95M, StockCount = 07, myQuantity = 0, otherQuantity = 0 }, 
                ...
                new Product { ProductID = 7, Name = "Unsteady Chair", Description = "Secret advantage", Category = "Chess", Price = 29.95M, StockCount = 03, myQuantity = 0, otherQuantity = 0 }, 
