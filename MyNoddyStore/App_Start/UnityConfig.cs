    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            mock.Setup(m => m.Products).Returns(new List<Product> { //a list automatically implements IEnumerable!.
                ...
                new Product { ProductID = 4, Name = "Corner Flags", Description = "For the field", Category = "Football", Price = 34.95M, StockCount = 12, myQuantity = 0, otherQuantity = 0 }, 
                new Product { ProductID = 5, Name = "Stadium", Description = "Flat-packed 35 K seater. One", Category = "Football", Price = 79500M, StockCount = 13, myQuantity = 0, otherQuantity = 0 }, 
                new Product { ProductID = 6, Name = "Thinking Cap", Description = "Improve brain-power", Category = "Chess", Price = 16M, StockCount = 14, myQuantity = 0, otherQuantity = 0 }, 
                new Product { ProductID = 7, Name = "Unsteady Chair", Description = "Secret advantage", Category = "Chess", Price = 29.95M, StockCount = 15, myQuantity = 0, otherQuantity = 0 }, 
                new Product { ProductID = 8, Name = "Human Chess Board", Description = "A fun family game", Category = "Chess", Price = 75M, StockCount = 16, myQuantity = 0, otherQuantity = 0 }, 
